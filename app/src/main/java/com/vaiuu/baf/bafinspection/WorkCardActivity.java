...
public class WorkCardActivity extends Activity implements BaseSliderView.OnSliderClickListener,
    ...
    private void initUI() {
        ...
        for(String name : HashMapForLocalRes .keySet()){
            ...
            TextSliderView textSliderView = new TextSliderView(WorkCardActivity.this);
